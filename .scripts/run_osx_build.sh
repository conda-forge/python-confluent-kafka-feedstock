...
validate_recipe_outputs "python-confluent-kafka-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="python-confluent-kafka-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi